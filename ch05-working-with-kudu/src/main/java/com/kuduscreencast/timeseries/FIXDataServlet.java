...
public class FIXDataServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try {
      ...
      /**rs = stmt.executeQuery("SELECT stocksymbol,max(orderqty) AS max_order, trunc(cast(transacttime/1000 as timestamp), \"MI\") AS time_window FROM fixdata " +
              ...
              "ORDER BY stocksymbol, time_window;");**/
